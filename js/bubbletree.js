    ...
    */
	...
	me.traverseBubbles = function(parentBubble) {
		...
		$.each(children, function(i,c) {
			...
			// fí[r jedes kind einen bubble anlegen und mit dem parent verbinden
			oa += da;
...
BubbleTree.LABEL_MAPPING = {
  ...
  "gikai-gikai":"ésãcâÔ",
  "soumu":"ésê≠",
  "soumu-kanri":"ëçñ±ä«óù",
  "soumu-kikaku":"äÈâÊ",
  "soumu-zeimu":"ê≈ñ±",
  "soumu-senkyo":"ëIãì",
  "soumu-jinji":"êléñàœàıâÔ",
  "soumu-kansa":"äƒç∏àœàı",
  "shimin":"ésñØ",
  "shimin-shimin":"ésñØ",
  "shimin-koseki":"åÀê–èZñØäÓñ{ë‰í†",
  "shimin-roudoufukushi":"òJì≠ïüéÉ",
  "kenkoufukushi":"åíçNïüéÉ",
  "kenkoufukushi-kenkou":"åíçNïüéÉ",
  "kenkoufukushi-shougai":"èùäQï€åØïüéÉ",
  "kenkoufukushi-kourei":"çÇóÓï€åíïüéÉ",
  "kenkoufukushi-jidou":"éôì∂ï€åíïüéÉ",
  "kenkoufukushi-seikatsu":"ê∂äàï€åÏ",
  "kenkoufukushi-saigai":"ç–äQã~èï",
  "kenkoufukushi-hokeneisei":"ï€åíâqê∂",
  "kankyou":"ä¬ã´",
  "kankyou-kankyou":"ä¬ã´",
  "keizai":"åoçœ",
  "keizai-shoukou":"è§çH",
  "keizai-nourin":"î_ó—",
  "doboku":"ìyñÿ",
  "doboku-kanri":"ìyñÿä«óù",
  "doboku-toshi":"ìsésåvâÊ",
  "doboku-jutaku":"èZëÓ",
  "doboku-douro":"ìπòHã¥ÇËÇÂÇ§",
  "doboku-ryokusei":"óŒê≠",
  "doboku-kasen":"âÕêÏ",
  "doboku-gesui":"â∫êÖìπ",
  "shoubou":"è¡ñh",
  "shoubou-shoubou":"è¡ñh",
  "kyoiku":"ã≥àÁ",
  "kyoiku-soumu":"ã≥àÁëçñ±",
  "kyoiku-shou":"è¨äwçZ",
  "kyoiku-chuu":"íÜäwçZ",
  "kyoiku-kou":"çÇìôäwçZ",
  "kyoiku-tokubetsu":"ì¡ï éxâáäwçZ",
  "kyoiku-kensetsu":"äwçZåöê›",
  "kyoiku-shakai":"é–âÔã≥àÁ",
  "kyoiku-shimin":"ésñØÉZÉìÉ^Å[",
  "kyoiku-kyushoku":"ï€åíããêH",
  "kousai":"åˆç¬",
  "kousai-kousai":"åˆç¬",
  "saigai":"ç–äQïúãå",
  "saigai-saigai":"ç–äQïúãå",
  "shoshishutsu":"èîéxèo",
  "shoshishutsu-kouei":"åˆâcäÈã∆",
  "yobi":"ó\îı",
  "yobi-yobi":"ó\îı"
};
